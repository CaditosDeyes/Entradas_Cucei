        ...
        <div class="table-container current">
            <?php
                ...
                if ($resultActual->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='9'>No hay visitas actuales (Puerta Boulevard).</td></tr>";
                }
    ...
    <div class="table-container preview"> <!-- Asegúrate de que la clase table-container se aplique aquí -->
        <?php
            ...
            if ($resultPreview->num_rows > 0) {
                ...
                echo '<tr><td colspan="9">No hay visitas programadas para este periodo (Puerta Boulevard).</td></tr>';
            }
    ...
    <div class="right-block">
        ...
        <div class="post">
            ...
            if ($resultPost->num_rows > 0) {
                ...
                echo '<tr><td colspan="9">No hay visitas pasadas (Puerta Boulevard)</td></tr>';
            }
