...
<body>
    ...
    <?php
            ...
            //$sqlActual = "SELECT * FROM Puertas WHERE DiaEntrada = CURDATE() AND TIME(HoraEntrada) BETWEEN '$horaAntes5' AND '$horaDespues5' AND PuertaEntrada = 1 ORDER BY TIME(HoraEntrada)";
    ...
    <div class="horizontal-block">
        ...
        <?php
            ...
            if ($resultActual->num_rows > 0) {
                ...
                echo "No hay visitas (Revolucion).";
            }
            //$conn->close();
        ?>
        </div>
            ...
            <div class="preview">
                 ...
                 echo "De: " . $horaDespues5 . " a " . $horaDespues . "<br>";
                    if ($resultPreview->num_rows > 0) {
                        ...
                        echo '<div class="container">
                            No hay visitas Preview (Revolucion)
                          </div>';
                    }
                ?>
            </div>
                ...
                echo "De: " . $horaAntes . " a " . $horaAntes5 . "<br>";
                    if ($resultPost->num_rows > 0) {
                        ...
                        Placa: ' . $row["placasCarro"] . '<br>
                         ...
                         echo '<div class="container">
                            No hay visitas POST (Revolucion)
                          </div>';
                    }
