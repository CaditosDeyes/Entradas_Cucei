...
<body>
    <div class="time">
        <div class="titlePuerta">Puerta Olímpica</div>
    ...
    <?php
            ...
            $sqlActual = "SELECT * FROM DatosP WHERE diaEntrada != CURDATE() AND TIME(horaEntrada) BETWEEN '$horaAntes5' AND '$horaDespues5' AND puertaEntrada = 'Olímpica' ORDER BY TIME(horaEntrada)";

            //$sqlActual = "SELECT * FROM DatosP WHERE diaEntrada != CURDATE() AND puertaEntrada = 'Olímpica'";
            ...
            $sqlPreview = "SELECT * FROM DatosP WHERE diaEntrada != CURDATE() AND TIME(horaEntrada) BETWEEN '$horaDespues5' AND '$horaDespues' AND puertaEntrada = 'Olímpica' ORDER BY TIME(horaEntrada)";
            $resultPreview = $cone->query($sqlPreview);
            
            $sqlPost = "SELECT * FROM DatosP WHERE diaEntrada != CURDATE() AND TIME(horaEntrada) BETWEEN '$horaAntes' AND '$horaAntes5' AND puertaEntrada = 'Olímpica' ORDER BY TIME(horaEntrada)";
            ...
            <div class="preview">
                 ...
                 echo "De: " . $horaDespues5 . " a " . $horaDespues . "<br>";
                    if ($resultPreview->num_rows > 0) {
                        ...
                        echo '<div class="container">
                            No hay visitas Preview (Olímpica)
                          </div>';
                    }
                ?>
            </div>
